  ...
  return (
    <div className={cn('w-full h-16 drag')}>
      <div className='h-full w-full flex flex-row justify-center items-center border-b border-b-accent/60'>
        <div className='flex flex-row justify-start items-center bg-muted text-primary rounded-sm pl-4 pr-2 py-2 gap-2 ml-4 flex-shrink-0'>
          <span className='icon-[solar--library-outline] w-5 h-5'></span>
          <span className='text-sm font-extrabold'>插件市场</span>
          <div className='no-drag hover:bg-primary/10 w-6 h-6 flex flex-row justify-center items-center rounded-full cursor-pointer'>
