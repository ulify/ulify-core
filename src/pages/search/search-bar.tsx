...
export const SearchBar = () => {
  return (
    <div className='w-2/3 bg-muted flex flex-row rounded-xl justify-center items-center border border-muted/80 transition-all focus-within:bg-background focus-within:shadow'>
